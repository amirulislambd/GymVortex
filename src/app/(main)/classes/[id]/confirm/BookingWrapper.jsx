...
export default function BookingWrapper({ classData, id, booking, favorite }) {
    ...
    <>
        ...
        <div className="space-y-3">
            ...
            >
              <div className="flex items-center gap-3 sm:gap-4">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#353534] flex items-center justify-center shrink-0">
                  <span className="material-symbols-outlined text-[#caf300]">
                    credit_card
                  </span>
                </div>
                <div>
          ...
          <label className="block cursor-not-allowed opacity-40">
            <div className="bg-[#201f1f]/70 backdrop-blur-xl p-4 flex items-center justify-between border-2 border-transparent">
              <div className="flex items-center gap-3 sm:gap-4">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#353534] flex items-center justify-center shrink-0">
                  <span className="material-symbols-outlined text-[#c6c6c7]">
                    token
                  </span>
                </div>
                <div>
      ...
      <section className="space-y-5 pt-2">
        ...
        <p
          ...
          style={{ fontFamily: "JetBrains Mono, monospace" }}
        >
          By clicking book now, you authorize a verification of your credentials
      ...
      <AnimatePresence>
        {toast && (
          <div className="fixed bottom-20 left-1/2 -translate-x-1/2 z-[60] w-[90%] max-w-sm">
            ...
            >
              <div
                className={`w-1.5 h-8 shrink-0 ${toast.type === "error" ? "bg-red-400" : "bg-[#caf300]"}`}
              />
